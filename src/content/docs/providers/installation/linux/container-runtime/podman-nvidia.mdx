...
description: How to configure Podman with NVIDIA GPU support for GPUFlow providers on Linux — container runtime setup for GPU rental hosting.
sidebar:
    label: 'Podman + NVIDIA'
    order: 4
---
...
# Update provider
podman pull docker.io/gpuflow/universal:latest
podman stop gpuflow-provider
